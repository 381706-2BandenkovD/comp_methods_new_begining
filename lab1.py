...
#Создание кнопки для задания начальных условий по клику мыши
...
#Создание кнопки очистки графиков, без перезапуска программы
...
#Создание текстовых полей для h, n, x0, y0, a, b, T,
